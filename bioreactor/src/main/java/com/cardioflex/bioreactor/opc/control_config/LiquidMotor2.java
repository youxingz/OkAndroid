...
public class LiquidMotor2 extends ControlConfig<LiquidMotor2.EquitPump2Payload> {
    ...
    private LiquidMotor2() {
        ...
        configNodeIdsRead.add(BioreactorNodeId.Equit_Pump2_ControlMode); // 控制方式0停止1控制循环3手动
        configNodeIdsRead.add(BioreactorNodeId.Equit_Pump2_Dir);
        configNodeIdsRead.add(BioreactorNodeId.Equit_Pump2_MeanVPM);
        configNodeIdsRead.add(BioreactorNodeId.Equit_Pump2_VolumePerRound); // 实时读取矫正参数
        // configNodeIdsRead.add(BioreactorNodeId.Equit_Pump2_Mode);        // 运行方式0定速1变速
        configNodeIdsWrite = new ArrayList<>();
        configNodeIdsWrite.add(BioreactorNodeId.Equit_Pump2_ControlMode); // 控制方式0停止1控制循环3手动
        configNodeIdsWrite.add(BioreactorNodeId.Equit_Pump2_Dir);
        configNodeIdsWrite.add(BioreactorNodeId.Equit_Pump2_MeanVPM);
