...
public class OkBluetoothServer {
    // Debugging
    ...
    protected OkBluetoothServer(BluetoothDevice device, Type type) {
        this.device = device;
        this.type = type;
        this.mAdapter = BluetoothAdapter.getDefaultAdapter();
    }

    public OkBluetoothServer(BluetoothDevice device) {
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (mState != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (OkBluetoothServer.this) {
                        switch (mState) {
                            case STATE_LISTEN:
